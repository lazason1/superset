 ...
 * under the License.
 */
import { SupersetPluginChartMultiAxisLineChart } from '../src';
 ...
 */
describe('superset-plugin-chart-multi-axis-line-chart', () => {
  it('exists', () => {
    expect(SupersetPluginChartMultiAxisLineChart).toBeDefined();
  });
});
